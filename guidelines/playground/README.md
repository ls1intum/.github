...
1.  **Create the application.**
    ...
    ```shell
    # Clone the template
    npx degit chromaui/intro-storybook-angular-template playground
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `playground` directory in your code editor of choice and building your first component!
